...
ActiveRecord::Schema.define(:version => 20140626220257) do
  ...
  create_table "refinery_events_places", :force => true do |t|
    t.string   "name"
    t.integer  "position"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "refinery_locationimages", :force => true do |t|
    t.string   "title"
    t.integer  "photo_id"
    t.integer  "position"
    t.datetime "created_at", :null => false
